const DOCS_DATA = {
  ...
  "definitions": {
    ...
    "FA5": {
      "id": "FA5",
      "title": "Datenstrom-Verarbeitung**: Analyse des kontinuierlichen Datenstroms.",
    ...
    "FA9": {
      "id": "FA9",
      "title": "Biofeedback und Auswertung**: Liefert die Grundlage für das unmittelbare Feedback (Erkennung sauberer vs. fehlerhafter Curls).",
      "file": "embedded/components/inferenz_engine/architecture.md",
      "line": 30,
      "links": [],
      "type": "FA"
