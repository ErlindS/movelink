const DOCS_DATA = {
  ...
  "definitions": {
    ...
    "FA3": {
      "id": "FA3",
      "title": "Es wird eine Datenbank benötigt, welche die Daten des Benutzers speichert. (UC-1, UC-3)",
      "file": "doc/Requirements.md",
      "line": 13,
      "links": [
        "UC-1",
    ...
    "FA2.4.1": {
      "id": "FA2.4.1",
      "title": "Ansteuerung der RGB-LED zur Signalisierung von Fehlern (Rot) und perfekten Curls (Grün).",
      "file": "embedded/components/led_display_controller/architecture.md",
      "line": 32,
      "links": [],
      "type": "FA"
    ...
    "FA2.4.2": {
      "id": "FA2.4.2",
      "title": "Aktualisierung des OLED-Displays zur textuellen Anzeige von Übungsstatus und Zähler.",
      "file": "embedded/components/led_display_controller/architecture.md",
      "line": 33,
      "links": [],
      "type": "FA"
