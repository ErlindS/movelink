const DOCS_DATA = {
  ...
  "definitions": {
    ...
    "FA2": {
      "id": "FA2",
      "title": "6 --> Gehause",
      "file": "doc/Traceability_Graph.md",
      "line": 138,
      "links": [],
      "type": "FA"
    },
    "FA3": {
      "id": "FA3",
      "title": "Verbindungsaufbau**: Ermöglicht der Mobile App den Bluetooth-Aufbau und das Pairing.",
    ...
    "NF1": {
      "id": "NF1",
      "title": "Latenz**: Durch die hardwarenahe I2C-Abfrage und das Vermeiden von blockierenden Delays wird eine niedrige E2E-Latenz ermöglicht.",
    ...
    "FA5": {
      "id": "FA5",
      "title": "Datenstrom-Verarbeitung**: Die Sensordaten werden kontinuierlich erfasst und für die Klassifikation aufbereitet.",
      "file": "embedded/components/sensordatenerfassung/architecture.md",
      "line": 26,
      "links": [],
      "type": "FA"
    ...
    "FA9": {
      "id": "FA9",
      "title": "Biofeedback und Auswertung**: Ermöglicht sofortiges visuelles Biofeedback direkt an der Sensor-Hardware.",
    ...
    "R2": {
      "id": "R2",
      "title": "Physisches Gehäuse**: Stabile Fixierung des Sensors am Arm, Schutz gegen Schweiß und Erschütterungen.",
  ...
  "references": {
    "UC-1": [
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 26,
        "context": "UC1[\"UC-1: Trainingsgerät verbinden\"]:::usecase"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 155,
        "context": "- **UC-1, UC-2, UC-3** -> **FA1 (Applikation)**: Dient als zentrale Steuerungs- und Eingabeschnittstelle."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 156,
        "context": "- **UC-1, UC-2** -> **FA2 (Trainingsgerät / Embedded)**: Erfasst die physischen Bewegungen des Nutzers."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 157,
        "context": "- **UC-1, UC-3** -> **FA3 (Datenbank)**: Speichert Benutzerprofile und Trainingsdaten persistent."
      }
    ],
    "FA2": [
      {
      ...
      },
      {
        ...
        "line": 11,
        "context": "**UC1**, **UC2** -> **FA2**: Zu dem System wird ein Trainingsgerät benötigt, welche als Input für der Bewegungen des Benutzers dient."
      },
      {
        "file": "doc/Requirements_old.md",
        "line": 12,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 33,
        "context": "FA2[\"FA2: Trainingsgerät (Bewegungsinput)\"]:::req"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 33,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 54,
        "context": "FA2_1[\"FA2.1: Sensordatenerfassung\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 55,
        "context": "FA2_2[\"FA2.2: Bewegungsklassifizierung\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 56,
        "context": "FA2_3[\"FA2.3: Bewegungsbewertung\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 57,
        "context": "FA2_4[\"FA2.4: LED-Statusanzeige\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 58,
        "context": "FA2_5[\"FA2.5: BLE-Streaming\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 59,
        "context": "FA2_6[\"FA2.6: Physisches Gehäuse\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 90,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 171,
        "context": "#### B. Embedded Firmware Container (FA2) -> [embedded/architecture.md](file:///c:/Users/erlin/repo/movelink/embedded/architecture.md)"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 172,
        "context": "* **FA2.1**: Sensor-Rohdatenerfassung (LSM6DS3 @ 50Hz)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 173,
        "context": "* **FA2.2**: Lokale Bewegungserkennung & Übungsklassifizierung (z. B. Bizeps-Curl)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 174,
        "context": "* **FA2.3**: Lokale Bewegungsbewertung (sauber vs. fehlerhaft)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 175,
        "context": "* **FA2.4**: Visuelle Status- und Feedbackausgabe über RGB-LEDs / OLED-Display."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 176,
        "context": "* **FA2.5**: Datenstrom-Übertragung als binäres Array via BLE Characteristics."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 177,
        "context": "* **FA2.6**: Physisches Schutzgehäuse mit Armbandbefestigung."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 192,
        "context": "* **Sensordatenerfassung (Loop)**: Erfüllt **FA2.1** (50Hz I2C-Abfrage in `Executable.ino`)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 193,
        "context": "* **Inferenz-Engine (Edge Impulse)**: Erfüllt **FA2.2** & **FA2.3** (CNN-Klassifizierung in `Executable.ino`)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 193,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 194,
        "context": "* **LED- & Display-Controller**: Erfüllt **FA2.4** (Feedbackausgabe)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 195,
        "context": "* **BLE-Streamer**: Erfüllt **FA2.5** (nRF52840 BLE GATT Service)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 196,
        "context": "* **Gehäuse**: Erfüllt **FA2.6** (Physisches 3D-Druck-Gehäuse aus `Gehause.py`)."
      },
      {
      ...
      },
      {
        "file": "embedded/architecture.md",
        "line": 26,
        "context": "**FA2.1** -> **[Sensordatenerfassung (Loop)](file:///c:/Users/erlin/repo/movelink/embedded/components/sensordatenerfassung/architecture.md)**: Liest kontinuierlich Beschleunigung (X, Y, Z) und Gyroskop (X, Y, Z)."
      },
      {
        "file": "embedded/architecture.md",
        "line": 27,
        "context": "**FA2.2, FA2.3** -> **[Inferenz-Engine (Edge Impulse)](file:///c:/Users/erlin/repo/movelink/embedded/components/inferenz_engine/architecture.md)**: Klassifiziert Übungsausführungen lokal auf dem Chip."
      },
      {
        "file": "embedded/architecture.md",
        "line": 27,
      ...
      },
      {
        "file": "embedded/architecture.md",
        "line": 28,
        "context": "**FA2.4** -> **[LED- & Display-Controller](file:///c:/Users/erlin/repo/movelink/embedded/components/led_display_controller/architecture.md)**: Bietet direktes visuelles Feedback an den Nutzer bei Fehlern."
      },
      {
        "file": "embedded/architecture.md",
        "line": 29,
        "context": "**FA2.5** -> **[BLE-Streamer](file:///c:/Users/erlin/repo/movelink/embedded/components/ble_streamer/architecture.md)**: Überträgt die erfassten Daten an den App-Container."
      },
      {
        "file": "embedded/architecture.md",
        "line": 30,
        "context": "**FA2.6** -> 5. **[Gehäuse](file:///c:/Users/erlin/repo/movelink/embedded/components/gehause/architecture.md)**: Bietet physischen Schutz, sodass das Tragen erleichtert wird."
      }
    ],
    "FA3": [
      {
      ...
      },
      {
        ...
        "line": 21,
        "context": "**FA3.1**: Das System speichert und verifiziert Benutzerprofile und Anmeldeinformationen persistent."
      },
      {
        "file": "database/architecture.md",
        "line": 22,
        "context": "**FA3.2**: Das System speichert aufgezeichnete Trainingseinheiten (Übungstyp, Wiederholungen, Qualität) persistent zur historischen Auswertung."
      },
      {
        "file": "database/architecture.md",
        "line": 26,
      ...
      },
      {
        "file": "doc/Requirements.md",
        "line": 13,
        "context": "**UC1**, **UC3** -> **FA3**: Es wird eine Datenbank benötigt, welche die Daten des Benutzers speichert."
      },
      {
        "file": "doc/Requirements_old.md",
        "line": 15,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 34,
        "context": "FA3[\"FA3: Datenbank (Datenspeicherung)\"]:::req"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 34,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 62,
        "context": "FA3_1[\"FA3.1: Profil- & Authdaten-Speicherung\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 63,
        "context": "FA3_2[\"FA3.2: Trainingsdaten-Persistenz\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 91,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 179,
        "context": "#### C. Database / Backend Container (FA3) -> [database/architecture.md](file:///c:/Users/erlin/repo/movelink/database/architecture.md)"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 180,
        "context": "* **FA3.1**: Speicherung und Verifizierung von Benutzerkonten & Auth-Tokens."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 181,
        "context": "* **FA3.2**: Persistente Speicherung aufgezeichneter Trainingseinheiten (Übungstyp, Wiederholungen, Qualität)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 197,
        "context": "* **Auth- & Profilservice**: Erfüllt **FA3.1** (REST-Endpoints)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 198,
        "context": "* **Trainings-DB / Session Store**: Erfüllt **FA3.2** (Persistenz-Layer)."
      }
    ],
    "NF1": [
      {
    ...
    "NF2": [
      ...
      },
      {
        ...
        "line": 37,
        "context": "5. **[BLE-Hook (useBLE)](file:///c:/Users/erlin/repo/movelink/app/hooks/useBLE.ts)**: Kapselt die Bluetooth-Gerätekommunikation und den Reconnect. (Erfüllt: FA1.3, NF2)"
      },
      {
        "file": "doc/AI_DOCUMENTATION_GUIDE.md",
        "line": 54,
      ...
      },
      {
        "file": "doc/Requirements.md",
        "line": 22,
        "context": "**NF2**: Zuverlässigkeit und Reconnect"
      }
    ],
    "NF3": [
      {
      ...
      },
      {
        "file": "app/architecture.md",
        "line": 34,
        "context": "2. **[SensorCard](file:///c:/Users/erlin/repo/movelink/app/components/SensorCard.tsx)**: Verwaltung der BLE-Geräteverbindung und Pairing. (Erfüllt: FA1.2, FA1.3, NF3)"
      },
      {
        "file": "doc/Requirements.md",
        "line": 25,
        "context": "**NF3**: Benutzbarkeit (Usability)"
      }
    ],
    "R1": [
      {
      ...
      },
      {
        "file": "doc/Requirements.md",
        "line": 32,
        "context": "**R1**: Plattform-Kompatibilität"
      }
    ],
    "FA1": [
      {
      ...
      },
      {
        "file": "app/architecture.md",
        "line": 26,
        "context": "**FA1.4**: Die App demonstriert grafisch die auszuführende Übungsausführung (z. B. via Lottie-Animation)."
      },
      {
        "file": "app/architecture.md",
        "line": 27,
      ...
      },
      {
        "file": "app/architecture.md",
        "line": 29,
        "context": "**FA1.7**: Die App zeigt Profildetails des Benutzers an."
      },
      {
        "file": "app/architecture.md",
        "line": 33,
        "context": "1. **[SideNav](file:///c:/Users/erlin/repo/movelink/app/components/SideNav.tsx)**: Navigationskomponente für die App-Steuerung. (Erfüllt: FA1.1)"
      },
      {
        "file": "app/architecture.md",
        "line": 34,
      ...
      },
      {
        "file": "app/architecture.md",
        "line": 35,
        "context": "3. **[LiveChart](file:///c:/Users/erlin/repo/movelink/app/components/LiveChart.tsx)**: Echtzeit-Visualisierung der IMU-Beschleunigungs- und Gyroskopwerte. (Erfüllt: FA1.5)"
      },
      {
        "file": "app/architecture.md",
        "line": 36,
        "context": "4. **[SessionCard](file:///c:/Users/erlin/repo/movelink/app/components/SessionCard.tsx)**: Visualisierung historischer Trainingseinheiten. (Erfüllt: FA1.6)"
      },
      {
        "file": "app/architecture.md",
        "line": 37,
      ...
      },
      {
        "file": "app/architecture.md",
        "line": 38,
        "context": "6. **[ProfileCard](file:///c:/Users/erlin/repo/movelink/app/components/ProfileCard/architecture.md)**: Visualisierung der Benutzerprofildetails. (Erfüllt: FA1.7)"
      },
      {
        "file": "doc/AI_DOCUMENTATION_GUIDE.md",
        "line": 16,
      ...
      },
      {
        "file": "doc/Requirements.md",
        "line": 9,
        "context": "**UC1**, **UC2**, **UC3** -> **FA1**: Es wird eine Applikation angeboten, welche als Input für die Steuerung für den Benutzer dient."
      },
      {
        "file": "doc/Requirements_old.md",
        "line": 9,
        "context": "**FA1**: Dashboard und Navigation"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 32,
        "context": "FA1[\"FA1: Applikation (Steuerung)\"]:::req"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 32,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 45,
        "context": "FA1_1[\"FA1.1: Navigation & Menüs\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 46,
        "context": "FA1_2[\"FA1.2: Geräte-Scanning\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 47,
        "context": "FA1_3[\"FA1.3: BLE-Verbindungsaufbau\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 48,
        "context": "FA1_4[\"FA1.4: Übungs-Demonstration\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 49,
        "context": "FA1_5[\"FA1.5: Echtzeit-Visualisierung\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 50,
        "context": "FA1_6[\"FA1.6: Historische Analyse\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 51,
        "context": "FA1_7[\"FA1.7: Profil & Authentifizierung\"]:::subreq"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 89,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 162,
        "context": "#### A. Mobile App Container (FA1) -> [app/architecture.md](file:///c:/Users/erlin/repo/movelink/app/architecture.md)"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 163,
        "context": "* **FA1.1**: Bereitstellung einer Navigationsstruktur für Geräte, Trainings und Verlauf."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 164,
        "context": "* **FA1.2**: Scanning nach verfügbaren Bluetooth-Sensorgeräten."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 165,
        "context": "* **FA1.3**: Stabile Bluetooth-Verbindung und Datenempfang."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 166,
        "context": "* **FA1.4**: Grafische Demonstration der Übungen (z. B. via Lottie-Animation)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 167,
        "context": "* **FA1.5**: Echtzeit-Visualisierung der IMU-Beschleunigungs- und Drehraten."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 168,
        "context": "* **FA1.6**: Anzeige historischer Trainingsstatistiken."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 169,
        "context": "* **FA1.7**: Anzeige von Benutzerprofilen und Auth-Status."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 185,
        "context": "* **SideNav.tsx**: Erfüllt **FA1.1** (Navigation)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 186,
        "context": "* **SensorCard.tsx**: Erfüllt **FA1.2** (Geräte-Scanning) & **FA1.3** (Verbindungsaufbau)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 186,
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 187,
        "context": "* **useBLE.ts**: Erfüllt **FA1.3** (Bluetooth-Kommunikation und automatischer Reconnect)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 188,
        "context": "* **ExerciseDemo.tsx**: Erfüllt **FA1.4** (Lottie-Demos)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 189,
        "context": "* **LiveChart.tsx**: Erfüllt **FA1.5** (Echtzeit-Kurven)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 190,
        "context": "* **SessionCard.tsx**: Erfüllt **FA1.6** (Historie)."
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 191,
        "context": "* **ProfileCard**: Erfüllt **FA1.7** (Profil-UI)."
      }
    ],
    "FA4": [
      {
    ...
    "FA5": [
      ...
      },
      {
        "file": "doc/Requirements_old.md",
        "line": 21,
        "context": "**FA5**: Datenstrom-Verarbeitung"
      },
      {
        "file": "doc/UseCases.md",
        "line": 33,
    ...
    "FA9": [
      ...
      },
      {
        "file": "doc/Requirements_old.md",
        "line": 33,
        "context": "**FA9**: Biofeedback und Auswertung"
      },
      {
        "file": "doc/UseCases.md",
        "line": 33,
    ...
    "UC-2": [
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 27,
        "context": "UC2[\"UC-2: Echtzeit-Training überwachen\"]:::usecase"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 155,
    ...
    "UC-3": [
      ...
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 28,
        "context": "UC3[\"UC-3: Trainingsdaten einsehen\"]:::usecase"
      },
      {
        "file": "doc/Traceability_Graph.md",
        "line": 155,
  ...
  "codeContents": {
    ...
    "doc/Traceability_Graph.md": "# Traceability- & System-Hierarchie (MoveLink)\n\nDieses Dokument visualisiert und beschreibt die logische Hierarchie von den Benutzeranforderungen (Use Cases) über die Systemanforderungen (Requirements) bis hin zu den C4-Containern, deren spezifischen Anforderungen und den implementierten Komponenten.\n\n---\n\n## 1. Traceability-Graph\n\nDer folgende Graph zeigt die durchgängige Traceability:\n* **Rot (Use Cases)**: Aus Szenarien abgeleitete Benutzerinteraktionen.\n* **Blau (Systemanforderungen)**: Abstrakte Anforderungen aus [Requirements.md](file:///c:/Users/erlin/repo/movelink/doc/Requirements.md).\n* **Grün (C4-Container)**: Eigenständige deploybare Einheiten (C4-Ebene 2).\n* **Gelb (Container-Anforderungen)**: Detaillierte Anforderungen innerhalb eines Containers.\n* **Grau (C4-Komponenten)**: Konkrete Implementierungsbausteine (C4-Ebene 3), die Aufgaben erfüllen.\n\n```mermaid\nflowchart TD\n    %% Styling\n    classDef usecase fill:#ffe5d9,stroke:#cc3300,stroke-width:2px,color:#000;\n    classDef req fill:#d1e8ff,stroke:#0066cc,stroke-width:2px,color:#000;\n    classDef container fill:#d4edda,stroke:#28a745,stroke-width:2px,color:#000;\n    classDef subreq fill:#fff3cd,stroke:#ffc107,stroke-width:2px,color:#000;\n    classDef component fill:#e2e3e5,stroke:#383d41,stroke-width:2px,color:#000;\n\n    subgraph Use_Cases [1. Anwendungsfälle (Use Cases)]\n        UC1[\"UC-1: Trainingsgerät verbinden\"]:::usecase\n        UC2[\"UC-2: Echtzeit-Training überwachen\"]:::usecase\n        UC3[\"UC-3: Trainingsdaten einsehen\"]:::usecase\n    end\n\n    subgraph System_Requirements [2. Systemanforderungen (doc/Requirements.md)]\n        FA1[\"FA1: Applikation (Steuerung)\"]:::req\n        FA2[\"FA2: Trainingsgerät (Bewegungsinput)\"]:::req\n        FA3[\"FA3: Datenbank (Datenspeicherung)\"]:::req\n    end\n\n    subgraph Containers [3. C4-Container]\n        AppContainer[\"Mobile App Container\\n(app/architecture.md)\"]:::container\n        EmbeddedContainer[\"Embedded Firmware Container\\n(embedded/architecture.md)\"]:::container\n        DbContainer[\"Database / Backend Container\\n(database/architecture.md)\"]:::container\n    end\n\n    subgraph Container_Requirements [4. Container-Anforderungen]\n        %% App Requirements\n        FA1_1[\"FA1.1: Navigation & Menüs\"]:::subreq\n        FA1_2[\"FA1.2: Geräte-Scanning\"]:::subreq\n        FA1_3[\"FA1.3: BLE-Verbindungsaufbau\"]:::subreq\n        FA1_4[\"FA1.4: Übungs-Demonstration\"]:::subreq\n        FA1_5[\"FA1.5: Echtzeit-Visualisierung\"]:::subreq\n        FA1_6[\"FA1.6: Historische Analyse\"]:::subreq\n        FA1_7[\"FA1.7: Profil & Authentifizierung\"]:::subreq\n\n        %% Embedded Requirements\n        FA2_1[\"FA2.1: Sensordatenerfassung\"]:::subreq\n        FA2_2[\"FA2.2: Bewegungsklassifizierung\"]:::subreq\n        FA2_3[\"FA2.3: Bewegungsbewertung\"]:::subreq\n        FA2_4[\"FA2.4: LED-Statusanzeige\"]:::subreq\n        FA2_5[\"FA2.5: BLE-Streaming\"]:::subreq\n        FA2_6[\"FA2.6: Physisches Gehäuse\"]:::subreq\n\n        %% DB Requirements\n        FA3_1[\"FA3.1: Profil- & Authdaten-Speicherung\"]:::subreq\n        FA3_2[\"FA3.2: Trainingsdaten-Persistenz\"]:::subreq\n    end\n\n    subgraph Components [5. C4-Komponenten]\n        %% App Components\n        SideNav[\"SideNav (UI-Steuerung)\"]:::component\n        SensorCard[\"SensorCard (BLE UI/Pairing)\"]:::component\n        BLEHook[\"useBLE (BLE-Hook)\"]:::component\n        ExerciseDemo[\"ExerciseDemo (Lottie-Demos)\"]:::component\n        LiveChart[\"LiveChart (Echtzeit-Graphen)\"]:::component\n        SessionCard[\"SessionCard (Historische Daten)\"]:::component\n        ProfileCard[\"ProfileCard (Nutzerprofil-UI)\"]:::component\n\n        %% Embedded Components\n        SensLoop[\"Sensordatenerfassung (Loop)\"]:::component\n        InfEngine[\"Inferenz-Engine (Edge Impulse)\"]:::component\n        LEDCtrl[\"LED- & Display-Controller\"]:::component\n        BLEStreamer[\"BLE-Streamer (GATT)\"]:::component\n        Gehause[\"Gehäuse (Physischer Schutz)\"]:::component\n\n        %% DB Components\n        AuthService[\"ProfileController / Auth Service\"]:::component\n        SessionStore[\"Trainings-DB / Session Store\"]:::component\n    end\n\n    %% Relations: Use Cases -> System Requirements\n    UC1 --> FA1\n    UC1 --> FA2\n    UC1 --> FA3\n    \n    UC2 --> FA1\n    UC2 --> FA2\n    \n    UC3 --> FA1\n    UC3 --> FA3\n\n    %% Relations: System Requirements -> Containers\n    FA1 --> AppContainer\n    FA2 --> EmbeddedContainer\n    FA3 --> DbContainer\n\n    %% Relations: Containers -> Container Requirements\n    AppContainer --> FA1_1\n    AppContainer --> FA1_2\n    AppContainer --> FA1_3\n    AppContainer --> FA1_4\n    AppContainer --> FA1_5\n    AppContainer --> FA1_6\n    AppContainer --> FA1_7\n\n    EmbeddedContainer --> FA2_1\n    EmbeddedContainer --> FA2_2\n    EmbeddedContainer --> FA2_3\n    EmbeddedContainer --> FA2_4\n    EmbeddedContainer --> FA2_5\n    EmbeddedContainer --> FA2_6\n\n    DbContainer --> FA3_1\n    DbContainer --> FA3_2\n\n    %% Relations: Container Requirements -> Components\n    FA1_1 --> SideNav\n    FA1_2 --> SensorCard\n    FA1_3 --> SensorCard\n    FA1_3 --> BLEHook\n    FA1_4 --> ExerciseDemo\n    FA1_5 --> LiveChart\n    FA1_6 --> SessionCard\n    FA1_7 --> ProfileCard\n\n    FA2_1 --> SensLoop\n    FA2_2 --> InfEngine\n    FA2_3 --> InfEngine\n    FA2_4 --> LEDCtrl\n    FA2_5 --> BLEStreamer\n    FA2_6 --> Gehause\n\n    FA3_1 --> AuthService\n    FA3_2 --> SessionStore\n\n    %% Cross-container and component interaction paths (dashed)\n    BLEStreamer -.->|BLE-Datenstrom| BLEHook\n    ProfileCard -.->|REST/Auth Query| AuthService\n    SessionCard -.->|REST/Session Query| SessionStore\n```\n\n---\n\n## 2. Detaillierte Hierarchie-Beschreibung\n\n### 2.1 Ebene 1: Use Cases & Ebene 2: Systemanforderungen (Abstrakt)\nAus den Szenarien in [UseCases.md](file:///c:/Users/erlin/repo/movelink/doc/UseCases.md) ergeben sich die abstrakten Hauptanforderungen in [Requirements.md](file:///c:/Users/erlin/repo/movelink/doc/Requirements.md):\n- **UC-1, UC-2, UC-3** -> **FA1 (Applikation)**: Dient als zentrale Steuerungs- und Eingabeschnittstelle.\n- **UC-1, UC-2** -> **FA2 (Trainingsgerät / Embedded)**: Erfasst die physischen Bewegungen des Nutzers.\n- **UC-1, UC-3** -> **FA3 (Datenbank)**: Speichert Benutzerprofile und Trainingsdaten persistent.\n\n### 2.2 Ebene 3 & 4: Container-Spezifische Anforderungen\nJedes abstrakte System-Requirement wird durch einen eigenen C4-Container realisiert, welcher die Anforderung in konkrete Teil-Anforderungen unterteilt:\n\n#### A. Mobile App Container (FA1) -> [app/architecture.md](file:///c:/Users/erlin/repo/movelink/app/architecture.md)\n* **FA1.1**: Bereitstellung einer Navigationsstruktur für Geräte, Trainings und Verlauf.\n* **FA1.2**: Scanning nach verfügbaren Bluetooth-Sensorgeräten.\n* **FA1.3**: Stabile Bluetooth-Verbindung und Datenempfang.\n* **FA1.4**: Grafische Demonstration der Übungen (z. B. via Lottie-Animation).\n* **FA1.5**: Echtzeit-Visualisierung der IMU-Beschleunigungs- und Drehraten.\n* **FA1.6**: Anzeige historischer Trainingsstatistiken.\n* **FA1.7**: Anzeige von Benutzerprofilen und Auth-Status.\n\n#### B. Embedded Firmware Container (FA2) -> [embedded/architecture.md](file:///c:/Users/erlin/repo/movelink/embedded/architecture.md)\n* **FA2.1**: Sensor-Rohdatenerfassung (LSM6DS3 @ 50Hz).\n* **FA2.2**: Lokale Bewegungserkennung & Übungsklassifizierung (z. B. Bizeps-Curl).\n* **FA2.3**: Lokale Bewegungsbewertung (sauber vs. fehlerhaft).\n* **FA2.4**: Visuelle Status- und Feedbackausgabe über RGB-LEDs / OLED-Display.\n* **FA2.5**: Datenstrom-Übertragung als binäres Array via BLE Characteristics.\n* **FA2.6**: Physisches Schutzgehäuse mit Armbandbefestigung.\n\n#### C. Database / Backend Container (FA3) -> [database/architecture.md](file:///c:/Users/erlin/repo/movelink/database/architecture.md)\n* **FA3.1**: Speicherung und Verifizierung von Benutzerkonten & Auth-Tokens.\n* **FA3.2**: Persistente Speicherung aufgezeichneter Trainingseinheiten (Übungstyp, Wiederholungen, Qualität).\n\n### 2.3 Ebene 5: Komponenten (Füllen Aufgaben aus)\nDie Komponenten sind die tatsächlichen Software-Module und physischen Teile, die diese Container-Anforderungen implementieren:\n* **SideNav.tsx**: Erfüllt **FA1.1** (Navigation).\n* **SensorCard.tsx**: Erfüllt **FA1.2** (Geräte-Scanning) & **FA1.3** (Verbindungsaufbau).\n* **useBLE.ts**: Erfüllt **FA1.3** (Bluetooth-Kommunikation und automatischer Reconnect).\n* **ExerciseDemo.tsx**: Erfüllt **FA1.4** (Lottie-Demos).\n* **LiveChart.tsx**: Erfüllt **FA1.5** (Echtzeit-Kurven).\n* **SessionCard.tsx**: Erfüllt **FA1.6** (Historie).\n* **ProfileCard**: Erfüllt **FA1.7** (Profil-UI).\n* **Sensordatenerfassung (Loop)**: Erfüllt **FA2.1** (50Hz I2C-Abfrage in `Executable.ino`).\n* **Inferenz-Engine (Edge Impulse)**: Erfüllt **FA2.2** & **FA2.3** (CNN-Klassifizierung in `Executable.ino`).\n* **LED- & Display-Controller**: Erfüllt **FA2.4** (Feedbackausgabe).\n* **BLE-Streamer**: Erfüllt **FA2.5** (nRF52840 BLE GATT Service).\n* **Gehäuse**: Erfüllt **FA2.6** (Physisches 3D-Druck-Gehäuse aus `Gehause.py`).\n* **Auth- & Profilservice**: Erfüllt **FA3.1** (REST-Endpoints).\n* **Trainings-DB / Session Store**: Erfüllt **FA3.2** (Persistenz-Layer).\n",
    ...
    "doc/Requirements_old.md": "# Systemanforderungen (Requirements)\n\nDieses Dokument definiert die funktionalen und nicht-funktionalen Anforderungen sowie die Randbedingungen des MoveLink-Systems.\n\n---\n\n## Funktionale Anforderungen\n\n**FA1**: Dashboard und Navigation\nDas System muss eine Navigationsstruktur (Reiter/Menü) für Hardwaregeräte, Trainings und vergangene Trainingseinheiten bereitstellen. *(Bezug: UC-1, UC-2, UC-3)*\n\n**FA2**: Geräte-Scanning\nDas System muss eine Liste verfügbarer Bluetooth-Hardwaregeräte anzeigen und den aktuellen Verbindungsstatus visualisieren. *(Bezug: UC-1)*\n\n**FA3**: Verbindungsaufbau\nDas System muss in der Lage sein, eine stabile Bluetooth-Verbindung mit dem IMU-Sensor herzustellen. *(Bezug: UC-1)*\n\n**FA4**: Trainings-Detailansicht\nDas System muss eine detaillierte Ansicht für ein ausgewähltes Training anzeigen. *(Bezug: UC-2)*\n\n**FA5**: Datenstrom-Verarbeitung\nDas System muss kontinuierliche Bewegungsdatenströme vom Sensor empfangen, filtern und verarbeiten können. *(Bezug: UC-2)*\n\n**FA6**: Echtzeit-Visualisierung\nDas System muss die empfangenen Sensordaten und Bewegungen in Echtzeit visualisieren. *(Bezug: UC-2)*\n\n**FA7**: Historische Analyse\nDas System muss historische Bewegungsdaten grafisch und statistisch anzeigen können. *(Bezug: UC-3)*\n\n**FA8**: Übungs-Demonstration\nDas System muss eine grafische Demonstration der auszuführenden Übungsbewegung anzeigen, sobald das Training gestartet wird. *(Bezug: UC-2)*\n\n**FA9**: Biofeedback und Auswertung\nDas System muss den Bewegungsfortschritt in Echtzeit visualisieren, mit der Zielvorgabe vergleichen und bei korrekter Durchführung positives Feedback (visuell und haptisch) ausgeben. *(Bezug: UC-2)*\n\n---\n\n## Nicht-funktionale Anforderungen (Muss-Kriterien)\n\n**NF1**: Latenz\nDie End-to-End-Latenz von der physischen Sensorbewegung bis zur visuellen Darstellung in der App muss ≤ 100 ms sein.\n\n**NF2**: Zuverlässigkeit und Reconnect\nBei Verbindungsabbrüchen muss die App den Nutzer umgehend benachrichtigen und automatische Wiederverbindungsversuche (Reconnect) starten.\n\n**NF3**: Benutzbarkeit (Usability)\nDas Bluetooth-Pairing mit dem Sensor darf maximal zwei manuelle Interaktionen erfordern.\n\n---\n\n## Randbedingungen\n\n**R1**: Plattform-Kompatibilität\nDie mobile Applikation muss nativ oder als hybride App auf Android-Geräten lauffähig sein.\n\n**R2**: Physisches Gehäuse\nFür das Trainingsgeräte braucht es einen Sensor. Dieser Sensor sollte bestenfalls nicht lose auf der Haut getragen werden\n",
